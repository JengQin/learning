 ...
 * 原始的数据来源表
 */
public class SourceTableNode extends SelectTableNode {


    // 真正的表名
    private String tableName;

    public SourceTableNode(String dbName, String tableName, String tableAlias) {
    ...
    public void generateColumns() {
        TableNode parentTable = getParentTable().get(0);
        // 获取parent table的列信息
