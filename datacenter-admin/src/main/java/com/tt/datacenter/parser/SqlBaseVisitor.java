...
public interface SqlBaseVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#sourceTable}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSourceTable(SqlBaseParser.SourceTableContext ctx);
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#databaseName}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDatabaseName(SqlBaseParser.DatabaseNameContext ctx);
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#sourceTableName}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSourceTableName(SqlBaseParser.SourceTableNameContext ctx);
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#targetTable}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTargetTable(SqlBaseParser.TargetTableContext ctx);
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#targetTableName}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTargetTableName(SqlBaseParser.TargetTableNameContext ctx);
	/**
