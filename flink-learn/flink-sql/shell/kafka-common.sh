...
#    zookeeperAddress=$2
#    topicName="$1"
#    create_kafka_topic 1 1 $topicName $zookeeperAddress
#
...
function create_kafka_topic {
    $KAFKA_DIR/bin/kafka-topics.sh --create --zookeeper $4 --replication-factor $1 --partitions $2 --topic $3
}
...
function send_messages_to_kafka {
    echo -e $1 | $KAFKA_DIR/bin/kafka-console-producer.sh --broker-list $3 --topic $2
}
